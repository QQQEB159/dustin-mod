...
importScript("data/global/collision");
importScript("data/global/graphics");
importScript("data/global/overworld");
importScript("data/global/saves");
importScript("data/global/utils");
importScript("data/global/window");
