...
function create() {
    ...
    else if(FunkinSave.getWeekHighscore("dusttale-1", "hard").date != null || FunkinSave.getSongHighscore("cornered", "hard").score > 1 && FunkinSave.getSongHighscore("avulsion", "hard").score > 1 && FunkinSave.getSongHighscore("broken-reality", "hard").score > 1 && (FunkinSave.getSongHighscore("you-are", "hard").score > 1 || FunkinSave.getSongHighscore("the-uprising", "hard").score > 1))
